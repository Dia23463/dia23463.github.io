...
const Skills = () => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-row flex-wrap gap-6 justify-center w-full mt-2">
            <BoxComponent
            Title="Full Stack Development"
            bullets={[
              "Proficient in building responsive web applications using React.js and Tailwind CSS.",
              "Experienced in backend development with Node.js and Express.",
            ...
            <BoxComponent
              ...
              bullets={[
                "Experienced in developing machine learning models using Python and TensorFlow.",
                "Skilled in data preprocessing, feature engineering, and model evaluation.",
                "Proficient in deploying AI models using Flask and Docker."
              ]}
            />
            <BoxComponent
            Title={"Data Science & Analytics"}
            bullets={[
              "Proficient in data analysis using Python libraries such as Pandas and NumPy.",
              "Experienced in data visualization with Matplotlib and Seaborn.",
              "Skilled in statistical analysis and hypothesis testing."
            ]}
            />
    </div>
    <div>
    <div className="self-stretch flex flex-row flex-wrap items-center justify-center py-5 px-0 box-border gap-[2px] min-h-[200px] text-center text-xl mq825:gap-[35px] mq450:gap-[18px]">
          {skills.map(skill => (
